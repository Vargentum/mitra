...
//    photo changing
    $('.product__photo').each(function(){
        var photos = $(this).find('.product__photo__primary li');
        var thumbs = $(this).find('.product__photo__secondary li');
...
//    search expanding
    $('.b-search--expanded').each(function(){
        var trigger = $(this).find('.search__secondary__trigger');
        var expanded = $(this).find('.search__secondary');
